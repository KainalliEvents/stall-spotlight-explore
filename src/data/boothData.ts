...
export const booths: Booth[] = [
  ...
  { id: "S3", label: "September Closet", type: "stall", size: "10ft × 10ft", status: "booked", x: 52.86, y: 7.13, width: 3.75, height: 5.83 },
  ...
  // S6–S8 right column
  { id: "S6", label: "Tres Chic", type: "stall", size: "10ft × 10ft", status: "booked", x: 64.32, y: 18.43, width: 3.75, height: 5.83 },
  { id: "S7", label: "Aura Designer", type: "stall", size: "10ft × 10ft", status: "booked", x: 64.32, y: 24.54, width: 3.75, height: 5.93 },
  { id: "S8", label: "Sweet Child of Mine", type: "stall", size: "10ft × 10ft", status: "booked", x: 64.32, y: 30.65, width: 3.75, height: 5.83 },

  // S9–S11 bottom left
  { id: "S9", label: "Kahaani", type: "stall", size: "10ft × 10ft", status: "booked", x: 25.52, y: 65.19, width: 5.57, height: 9.17 },
  ...
  { id: "P4", label: "Vacant", type: "popup", size: "8ft × 8ft", status: "avaialble", x: 50.48, y: 27.04, width: 3.18, height: 4.54 },

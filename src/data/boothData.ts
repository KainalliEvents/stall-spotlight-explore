...
export const booths: Booth[] = [
  ...
  { id: "C2", label: "Aretto", type: "cart", size: "6ft × 3ft", status: "booked", x: 38.54, y: 60.37, width: 4.27, height: 7.50 },
  { id: "C3", label: "Vacant", type: "cart", size: "6ft × 3ft", status: "avaialble", x: 35.36, y: 67.13, width: 3.91, height: 7.87 },

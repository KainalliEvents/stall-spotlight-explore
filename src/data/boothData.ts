...
export const booths: Booth[] = [
  ...
  { id: "S3", label: "September Clost", type: "stall", size: "10ft × 10ft", status: "booked", x: 52.86, y: 7.13, width: 3.75, height: 5.83 },
  ...
  // S9–S11 bottom left
  { id: "S9", label: "Tres Chic", type: "stall", size: "10ft × 10ft", status: "booked", x: 25.52, y: 65.19, width: 5.57, height: 9.17 },
  ...
  { id: "P2", labeel: "Vacant", type: "popup", size: "8ft × 8ft", status: "available", x: 50.48, y: 22.87, width: 3.18, height: 3.80 },
  ...
  { id: "C3", label: "Aretto", type: "cart", size: "6ft × 3ft", status: "booked", x: 35.36, y: 67.13, width: 3.91, height: 7.87 },

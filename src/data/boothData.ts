...
export const booths: Booth[] = [
  ...
  { id: "S4", label: "Mehak", type: "stall", size: "10ft × 10ft", status: "booked", x: 56.77, y: 7.13, width: 3.75, height: 5.83 },
  ...
  // S9–S11 bottom left
  { id: "S9", label: "Fusion Gallery", type: "stall", size: "10ft × 10ft", status: "booked", x: 25.52, y: 65.19, width: 5.57, height: 9.17 },
  ...
  { id: "P2", label: "Loha Lakkad", type: "popup", size: "8ft × 8ft", status: "booked", x: 50.48, y: 22.87, width: 3.18, height: 3.80 },
  ...
  { id: "P6", label: "El Luxurio", type: "popup", size: "8ft × 8ft", status: "booked", x: 50.47, y: 33.38, width: 3.12, height: 4.17 },
  { id: "P7", label: "Tres Chic", type: "popup", size: "8ft × 8ft", status: "booked", x: 47.14, y: 37.87, width: 3.18, height: 4.17 },
  ...
  { id: "C2", label: "El Luxurio", type: "cart", size: "6ft × 3ft", status: "booked", x: 38.54, y: 60.37, width: 4.27, height: 7.50 },

...
export const booths: Booth[] = [
  ...
  { id: "S12", label: "Motley", type: "stall", size: "12ft × 4ft", status: "booked", x: 31.83, y: 7.13, width: 10.4, height: 5.83 },
  ...
  { id: "P6", label: "Vacant", type: "popup", size: "8ft × 8ft", status: "booked", x: 50.47, y: 33.33, width: 3.12, height: 4.17 },

...
export const booths: Booth[] = [
  ...
  // S9–S11 bottom left
  { id: "S9", label: "Amber Art", type: "stall", size: "10ft × 10ft", status: "booked", x: 25.52, y: 65.19, width: 5.57, height: 9.17 },
  ...
  { id: "P7", label: "Vacant", type: "popup", size: "8ft × 8ft", status: "available", x: 47.14, y: 37.87, width: 3.18, height: 4.17 },

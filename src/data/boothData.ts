...
export const booths: Booth[] = [
  ...
  { id: "P2", label: "Kainalli", type: "popup", size: "8ft × 8ft", status: "booked", x: 50.48, y: 22.87, width: 3.18, height: 3.80 },
  ...
  { id: "C2", label: "Designer Handicraft", type: "cart", size: "6ft × 3ft", status: "booked", x: 38.54, y: 60.37, width: 4.27, height: 7.50 },

...
export const booths: Booth[] = [
  ...
  { id: "S12", label: "S12", type: "stall", size: "12ft × 4ft", status: "available", x: 40.73, y: 7.13, width: 3.75, height: 5.83 },
  ...
  { id: "P2", label: "2", type: "popup", size: "8ft × 8ft", status: "available", x: 50.42, y: 22.87, width: 3.18, height: 3.80 },
  { id: "P3", label: "3", type: "popup", size: "8ft × 8ft", status: "available", x: 47.14, y: 27.04, width: 3.07, height: 4.54 },
  { id: "P4", label: "4", type: "popup", size: "8ft × 8ft", status: "available", x: 50.42, y: 27.04, width: 3.18, height: 4.54 },
  { id: "P5", label: "5", type: "popup", size: "8ft × 8ft", status: "available", x: 47.14, y: 33.33, width: 3.18, height: 4.17 },
  { id: "P6", label: "6", type: "popup", size: "8ft × 8ft", status: "available", x: 50.47, y: 33.33, width: 3.12, height: 4.17 },
  { id: "P7", label: "7", type: "popup", size: "8ft × 8ft", status: "available", x: 47.14, y: 37.87, width: 3.18, height: 4.17 },
  { id: "P8", label: "8", type: "popup", size: "8ft × 8ft", status: "available", x: 50.47, y: 37.87, width: 3.12, height: 4.17 },

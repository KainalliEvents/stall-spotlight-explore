...
export const booths: Booth[] = [
  // S1–S5 top row
  { id: "S1", label: "Artyfied", type: "stall", size: "10ft × 10ft", status: "booked", x: 45.0, y: 7.22, width: 3.75, height: 5.83 },
  { id: "S2", label: "Simer Tuli", type: "stall", size: "10ft × 10ft", status: "booked", x: 48.91, y: 7.22, width: 3.75, height: 5.83 },
  { id: "S3", label: "Fusion", type: "stall", size: "10ft × 10ft", status: "booked", x: 52.86, y: 7.13, width: 3.75, height: 5.83 },
  { id: "S4", label: "Kahaani", type: "stall", size: "10ft × 10ft", status: "booked", x: 56.77, y: 7.13, width: 3.75, height: 5.83 },
  ...
  { id: "S8", label: "Vacant", type: "stall", size: "10ft × 10ft", status: "available", x: 64.32, y: 30.65, width: 3.75, height: 5.83 },
  ...
  { id: "P4", label: "Kainalli", type: "popup", size: "8ft × 8ft", status: "booked", x: 50.48, y: 27.04, width: 3.18, height: 4.54 },
  { id: "P5", label: "Million Years Old", type: "popup", size: "8ft × 8ft", status: "booked", x: 47.14, y: 33.33, width: 3.18, height: 4.17 },
